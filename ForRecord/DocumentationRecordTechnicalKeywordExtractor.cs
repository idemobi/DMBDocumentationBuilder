...
// DMBDocumentationBuilder.csproj DocumentationRecordTechnicalKeywordExtractor.cs create at 2026/04/13 18:04:04
...
{
    /// <summary>
    /// Represents the DocumentationRecordTechnicalKeywordExtractor type used by DocumentationBuilder generation.
    /// </summary>
    public static class DocumentationRecordTechnicalKeywordExtractor
    {
        #region Fields
        ...
        {
            "record", "field", "fields", "method", "methods",
            "property", "properties",
            "get", "set", "init",
            "true", "false", "null"
        };
        ...
        public static string ExtractKeywordsAsString(DocumentationRecordPageModel model)
        {
        ...
        public static IReadOnlyList<string> ExtractKeywords(DocumentationRecordPageModel model)
        {
            if (model is null) throw new ArgumentNullException(nameof(model));

            HashSet<string> keywords = new(StringComparer.OrdinalIgnoreCase);
            Add(keywords, model.RecordName);
            ...
            foreach (DocumentationRecordPropertyItem property in model.Properties)
            {
                Add(keywords, property.PropertyName);
                Add(keywords, property.Signature);
            }
            foreach (DocumentationRecordMethodItem method in model.Methods)
            {
