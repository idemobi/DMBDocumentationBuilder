...
// DMBDocumentationBuilder.csproj DocumentationEnumTechnicalKeywordExtractor.cs create at 2026/04/13 17:04:59
...
{
    /// <summary>
    /// Represents the DocumentationEnumTechnicalKeywordExtractor type used by DocumentationBuilder generation.
    /// </summary>
    public static class DocumentationEnumTechnicalKeywordExtractor
    {
        #region Fields
        ...
        public static string ExtractKeywordsAsString(DocumentationEnumPageModel model)
        {
        ...
        public static IReadOnlyList<string> ExtractKeywords(DocumentationEnumPageModel model)
        {
            if (model is null) throw new ArgumentNullException(nameof(model));

            HashSet<string> keywords = new(StringComparer.OrdinalIgnoreCase);

            Add(keywords, model.EnumName);
            ...
            Add(keywords, model.UnderlyingType);
